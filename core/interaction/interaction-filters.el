;;; interaction-filters.el --- Per-column regex filters bound to `='  -*- lexical-binding: t; -*-
...
(require 'cl-lib)
(require 'state-cache)         ; `aq--obj-id', `aq--object-cache', `aq--total-objects'
(require 'state-region-ctx)    ; `aq-region-ctx', `aq--ctx-at-point', `aq--message'
(require 'state-dismissal)     ; `aq--dismissed-items', `aq--update-dismissed-footer'
...
(provide 'interaction-filters)
;;; interaction-filters.el ends here
