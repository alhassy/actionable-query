;;; render-splice.el --- Splice a view's rendered content into a host buffer  -*- lexical-binding: t; -*-
...
(require 'cl-lib)
(require 'transient)
(require 'state-region-ctx)         ; `aq-region-ctx*', `aq--ctx-at-point', `aq--rerender-region', `aq--suppress-help-echo-until'
(require 'state-dismissal)          ; `aq--post-deliver-hook'
(require 'interaction-row-reorder)  ; `aq--move-row'
(require 'interaction-bulk)         ; mark/unmark/bulk
(require 'interaction-popup)        ; `aq--current-row'
(require 'interaction-help-echo)    ; `aq--center-message', `aq--last-help-echo-obj'
(require 'interaction-keys)         ; `aq--region-keymap', `aq--actions->region-keymap', `aq--install-host-action-keys'
(require 'interaction-edit)         ; `aq--edit-current-cell-1'
(require 'point-async)                 ; generic ⏳ slot primitive
(require 'state-dismissal)          ; `aq--post-deliver-hook', heart helpers, `aq--undismiss-all'
...
(provide 'render-splice)
;;; render-splice.el ends here
