;;; state-dismissal.el --- Snooze, hearting, and footers  -*- lexical-binding: t; -*-
...
(require 'cl-lib)
(require 'savehist)
(require 'state-cache)         ; `aq--obj-id', `aq--total-objects'
(require 'state-region-ctx)    ; `aq--message'
...
(provide 'state-dismissal)
;;; state-dismissal.el ends here
