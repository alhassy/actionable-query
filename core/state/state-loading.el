;;; state-loading.el --- Spinner UI and auto-refresh timer  -*- lexical-binding: t; -*-
...
(require 'state-cache)         ; `aq--last-fetch-start-time', `aq--auto-refresh-timer'
...
(provide 'state-loading)
;;; state-loading.el ends here
