;;; aq-render-grouped.el --- Multi-table grouped rendering  -*- lexical-binding: t; -*-
...
(require 'cl-lib)
(require 'vtable)
(require 'aq-state-cache)         ; `aq--obj-id'
(require 'aq-state-dismissal)     ; `aq--dismissed-items'
(require 'aq-interaction-keys)    ; `aq--actions->vtable', `aq--vtable-keymap'
...
(provide 'aq-render-grouped)
;;; aq-render-grouped.el ends here
