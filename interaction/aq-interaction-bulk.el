;;; aq-interaction-bulk.el --- Row marking and bulk-action transient  -*- lexical-binding: t; -*-
...
(require 'cl-lib)
(require 'transient)
(require 'aq-state-region-ctx)    ; `aq-region-ctx', `aq--ctx-at-point'
...
(provide 'aq-interaction-bulk)
;;; aq-interaction-bulk.el ends here
