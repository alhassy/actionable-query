;;; mail.el --- Gmail INBOX view via actionable-query-defview  -*- lexical-binding: t; -*-
;;
...
;; File is `mail.el' but the feature stays `actionable-mail' --- `mail' is too
;; generic a symbol to claim in Emacs's mail-heavy namespace.
