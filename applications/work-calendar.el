;;; work-calendar.el --- Work-calendar / agenda / standup widget  -*- lexical-binding: t; -*-

;; Author: Musa Al-hassy <alhassy@gmail.com>

;;; Commentary:

;; The dashboard's day view (`dashboard/work-calendar'): a one-day agenda that
;; merges Google Calendar (gcalcli), personal calendars (secret iCal URLs),
;; org-agenda items (SCHEDULED / DEADLINE / body timestamps / sexps), and
;; Canadian holidays into one sorted, overlap-aware table.  `dashboard--items-for'
;; is the merge point; `dashboard--effective-date' threads the viewing day
;; through every source.  We can pick a day (`D'), span several (`v'), and share
;; the day's work as a Slack standup (`s', via `my/copy-as-slack').
...
(declare-function my/copy-as-slack "ext")
...
(provide 'work-calendar)
;;; work-calendar.el ends here
